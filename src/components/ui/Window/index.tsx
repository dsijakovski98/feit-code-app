  ...
  return (
    <Fragment>
      <section
        ref={windowEl}
        className={clsx(
          "group absolute overflow-hidden rounded-xl border border-content1 bg-content1 font-quicksand opacity-100 transition-all duration-300 data-[moving]:opacity-50 dark:shadow-xl dark:shadow-background dark:data-[moving]:opacity-80 dark:data-[moving]:shadow-transparent lg:static",
          {
