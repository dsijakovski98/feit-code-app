...
const Sidebar = () => {
  return (
    <nav className="sticky top-0 flex h-dvh flex-col items-center gap-8 border-r border-r-content4 bg-gradient-to-b from-content1 to-background to-40% px-3 pb-6 pt-4 font-quicksand">
      <Link
        to={ROUTES.dashboard}
